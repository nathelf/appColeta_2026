...
function AppSidebar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        { title: t('menu.users'), url: '/config/usuario', icon: Users }
      ]
    },
    {
      group: t('menu.system'),
                    ...
                    <SheetContent side="left" className="w-60 p-0">
                      ...
                      <div className="p-4 flex flex-col h-full">
                        <nav className="space-y-6 flex-1">
                          {[
                            { group: t('menu.home'), items: [{ title: t('menu.dashboard'), url: '/dashboard', icon: LayoutDashboard }] },
                            { group: t('menu.collection'), items: [
                              { title: t('menu.firstCollection'), url: '/coleta/primeira', icon: Fingerprint },
                              { title: t('menu.recollection'), url: '/coleta/recoleta', icon: RefreshCw }
                            ]},
                            { group: t('menu.administrative'), items: [{ title: t('menu.users'), url: '/config/usuario', icon: Users }] },
                            { group: t('menu.system'), items: [
                              { title: t('menu.sync'), url: '/sincronizacao', icon: Clock },
                              { title: t('menu.settings'), url: '/configuracoes', icon: Settings }
                            ]}
                          ].map((group) => (
