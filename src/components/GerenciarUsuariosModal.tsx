...
import { Search, Edit, Trash2, KeyRound, Power, PowerOff, AlertTriangle } from 'lucide-react';
...
export default function GerenciarUsuariosModal({ onClose }: GerenciarUsuariosModalProps) {
